...
<Duo alignItems="start">
  <div class="w-1/2 max-w-2xl max-lg:w-2/3 max-md:order-2 max-md:w-full max-md:self-start">
  ...
  <div class="relative flex aspect-square w-full max-w-sm justify-center border-2 border-brandMain max-lg:w-2/5 max-lg:self-end max-md:w-11/12 max-md:self-start">
      <img class="w-full h-auto m-0 z-10" src="/assets/thumbnails/progress-journal-v3.webp" />
      <div class="absolute -top-2 left-2 -z-0 aspect-square w-full border-2 border-brandMain bg-transparent">
      </div>
  </div>
</Duo>
